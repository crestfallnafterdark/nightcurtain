...
| [`04-turn-execution-chat-rendering.spec.js`](../../tests/e2e/04-turn-execution-chat-rendering.spec.js) | Turn Execution & Chat Chronicle | Mock LLM streaming, reasoning accordion toggle, tool call badges, markdown rendering, inline turn editing. |
...
| [`06-agent-inspector-virtualfs.spec.js`](../../tests/e2e/06-agent-inspector-virtualfs.spec.js) | Inspector, VirtualFS & Handshake Demo | Telemetry metrics, timer scheduling, VFS file creation, AST KeyPath query, Grep search, Handshake demo. |
