...
└── testing/                                   # Verification, QA & Test Harnesses
    ...
    ├── unit_and_integration.md                # Node Native Runner (98 suites: 52 Unit / 46 Integration), Integration Test Contracts
...
# Execute master test suite (98 suites: 52 unit + 46 integration)
npm test
