...
└── testing/                                   # Verification, QA & Test Harnesses
    ...
    ├── unit_and_integration.md                # Node Native Runner (92 suites: 46 Unit / 46 Integration), Integration Test Contracts
...
| [`testing/unit_and_integration.md`](testing/unit_and_integration.md) | Substrate Tests | 92 Node.js native test suites (46 Unit, 46 Integration), browser-polyfill test environment, runtime/messaging/tool-loop verification. |
...
# Execute master test suite (92 suites: 46 unit + 46 integration)
npm test
