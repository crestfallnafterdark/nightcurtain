...
└── testing/                                   # Verification, QA & Test Harnesses
    ...
    ├── unit_and_integration.md                # Node Native Runner (94 suites: 48 Unit / 46 Integration), Integration Test Contracts
...
| [`testing/unit_and_integration.md`](testing/unit_and_integration.md) | Substrate Tests | 94 Node.js native test suites (48 Unit, 46 Integration), browser-polyfill test environment, runtime/messaging/tool-loop verification. |
...
# Execute master test suite (94 suites: 48 unit + 46 integration)
npm test
